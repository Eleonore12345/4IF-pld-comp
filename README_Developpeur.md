...
L'exécution avec la commande `./ifcc [-target <architecture_cible>] <nom_prog>` permet de spécifier l’assembleur cible que l’utilisateur souhaite générer. Les options disponibles sont **x86** (par défaut) et **arm**.
